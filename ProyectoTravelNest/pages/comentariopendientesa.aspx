<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="comentariopendientesa.aspx.cs" Inherits="ProyectoTravelNest.pages.comentariopendientesa" %>
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="border-top mt-4 pt-4">
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex justify-content-between">
                                                        <h5 class="m-0" style="margin-right: 5px;">Huésped:&nbsp;<%# Eval("NombreHuesped")%></h5>
                                                    </div>
