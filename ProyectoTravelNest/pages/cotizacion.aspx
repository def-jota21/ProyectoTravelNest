                    ...
                    <div class="card-header">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <label for="exampleFormControlInput1" class="form-label mt-1">
                                        <asp:Label ID="lblCodigo" runat="server" /></label>

                                    <br />
                                    <label for="exampleFormControlInput1" class="form-label mt-2"><small>
                                        <asp:Label ID="lblNombreInmueble" runat="server" /></small></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="card-body">
                                ...
                                <p class="card-text">Tarifa de limpieza:
                                    <asp:Label ID="lblLimpieza" runat="server" /></p>
                                <p class="card-text">Tarifa por servicio de TravelNest:
                                    <asp:Label ID="lblServicio" runat="server" /></p>
                                <p class="card-text">Impuestos:
                                    <asp:Label ID="lblImpuestos" runat="server" /></p>
                                <p class="card-text">Cupon:
                                    <asp:Label ID="lblCupon" runat="server" /></p>
                                <hr />
                                <p><strong>Total (USD):
                                    <asp:Label ID="lblTotal" runat="server" /></strong></p>
                            </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
