...
figcaption{
    ...
    <div class="container mt-5">
        <div class="row">
                ...
                <div class="col">
                    <label for="exampleFormControlInput1" class="form-label" style="margin-top: 4.4rem">Huespedes</label>
                    ...
                    <button type="button" class="btn btn-primary lx mt-4" >Modificar Alojamiento</button>
                </div>
