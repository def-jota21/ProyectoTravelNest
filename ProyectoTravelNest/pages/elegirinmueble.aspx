...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="margin-top: 6vh;">
        <h1>Agregar, modificar o eliminar</h1>
                            ...
                            <a href="#" class="text-decoration-none" style="color: initial;">
                                <div class="package-item bg-white mb-2">
                                    ...
                                    <div style="clear: both;">
                                        ...
                                        <label class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero quae ipsum quas accusantium eum, consectetur...</label>
                                        <div class="border-top mt-4 pt-4">
                                            <div class="d-flex justify-content-around">
                                                <h6 class="m-0"><i class="fa fa-star text-primary"></i>4.5 <small>(250)</small></h6>
                                                <h5 class="m-0">$350</h5>
                                                <p><b>por noche</b></p>
                                            </div>
                                        </div>
