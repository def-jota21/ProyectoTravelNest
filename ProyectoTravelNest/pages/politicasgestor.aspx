<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="politicasgestor.aspx.cs" Inherits="ProyectoTravelNest.pages.politicasgestor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <h1 style="color: #7AB730;">Agregar Políticas para los Inmuebles</h1>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 my-2">
                            <div id="seccionAgregar" style="display: none; color: black">
                                ...
                                <div class="row">
                                    <asp:Label ID="Label3" runat="server" AssociatedControlID="txtPolitica" CssClass="form-label">Nombre Política:</asp:Label>
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtPolitica" Rows="7" MaxLength="60"></asp:TextBox>
                                </div>
